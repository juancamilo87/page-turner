...
import co.wlue.pageturner.utils.CustomSeeScoreView;
...
//     */
//    private CustomSeeScoreView ssview;
//
//    /**
...
//        });
//
//        ssview = new CustomSeeScoreView(this, cursorView, getAssets(), new CustomSeeScoreView.ZoomNotification(){
//
...
//            }
//
//        }, new CustomSeeScoreView.TapNotification(){
//            @Override
...
//
//        ssview.setScore(score, new ArrayList<Boolean>(), magnification); // relayout after transpose
//        showTitle(score);
